...
class RoleIntegrationTest extends IntegrationBaseTest {
    ...
    void shouldAddNewEntryIntoDatabaseWhenNewRoleIsAdded() {
        service.addRole(ROLE_NAME, RoleType.IDAM, SecurityClassification.PUBLIC, AccessManagementType.ROLE_BASED);
    ...
    void shouldUpdateExistingEntryWhenDuplicateRolesAreAdded() {
        service.addRole(ROLE_NAME, RoleType.IDAM, SecurityClassification.PUBLIC, AccessManagementType.ROLE_BASED);
        service.addRole(ROLE_NAME, RoleType.RESOURCE, SecurityClassification.PRIVATE, AccessManagementType.EXPLICIT);
        ...
        assertThat(role.getAccessManagementType()).isEqualTo(AccessManagementType.EXPLICIT);
    }
