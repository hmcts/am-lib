    ...
    void revokeResourceAccessMethodShouldRejectInvalidArguments(ExplicitAccessMetadata accessMetadata) {
        assertThatExceptionOfType(IllegalArgumentException.class)
            ...
            .withMessageMatching(expectedValidationMessagesRegex(
                ...
                "accessMetadata.definition - must not be null",
                "accessMetadata.definition.serviceName - must not be blank",
                "accessMetadata.definition.resourceType - must not be blank",
                "accessMetadata.definition.resourceName - must not be blank",
