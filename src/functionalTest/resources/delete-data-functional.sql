...
delete from resources where service_name = 'cmc-test' and resource_type ='case-test' and resource_name = 'claim-test';
delete from services where service_name = 'cmc-test';
